function mrbMap(condition) {
    ...
    // set file and variable name depending on input
    if (condition == "precip") {
        var file = "data/sst_small.csv"
    ...
    d3.csv(file).then(function (data) {
        ...
        var varMax = d3.max(data, d => d.var);
        var varMin = d3.max(data, d => d.var);

        // color scale function
        const myColor = d3.scaleLinear().domain([varMin, 32]).range(["white", "blue"]);
